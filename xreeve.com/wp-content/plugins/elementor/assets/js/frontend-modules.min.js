    ...
    [354], {
        ...
        5658: e => {
            ...
            e.exports = elementorModules.ViewModule.extend({
                ...
                stretch() {
                    ...
                    var a = {};
                    a.width = s + "px", a[this.getSettings("direction")] = o + "px", n.css(a)
                },
                reset() {
                    var e = {
                        width: ""
        ...
        2618: (e, t, n) => {
            ...
            class ArgsObject extends i.default {
                ...
                requireArgument(e) {
                    if (!(arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.args).hasOwnProperty(e)) throw Error(`${e} is required.`)
                }
                    ...
                    t += parseInt(this.elements.$container.css("margin-top"), 10), this.elements.$items.each((function(i) {
                        ...
                        if (r) {
                            var a = o.position(),
                                c = i % s,
                                u = a.top - t - e[c];
                            u -= parseInt(o.css("margin-top"), 10), u *= -1, o.css("margin-top", u + "px"), e[c] += l
                        } else e.push(l)
                    }))
                }
            })
            ...
            t.default = class Scroll {
                ...
                static getElementViewportPercentage(e) {
                    ...
                    const n = e[0].getBoundingClientRect(),
                        ...
                        a = 0 - l + r,
                        c = n.top + r + e.height() - l + o,
                        u = Math.max(0, Math.min(a / c, 1));
